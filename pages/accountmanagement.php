												...
												foreach($getDonates as $donate) {
													...
													$main_content .= '
														<tr bgcolor="'.$bgcolor.'">
															...
															<td>'.$donate['points'].' points premium by R$ '.$donate['price'].'</td>
...
{ 
		...
		{ 
			...
			if($_POST['savecharacter'] != 1)
			{
				...
				$main_content .= ' and sex for your character. <br/>In any case the name must not violate the naming conventions stated in the <a href="?subtopic=rules" target="_blank" >'.htmlspecialchars($config['server']['serverName']).' Rules</a>, or your character might get deleted or name locked.';
