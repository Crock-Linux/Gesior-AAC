		...
		if($step == 5) {
			...
			if( $_SERVER['REQUEST_METHOD']=='POST' ) {
				...
				if( isset( $_SESSION['hash'] ) && $_SESSION['hash'] == $hash ) {		
					...
					if($donateMethod == "pagseguro")						
						$add_order = $SQL->query("INSERT INTO `z_shop_donates` (`date`,`reference`,`account_name`,`method`,`price`,`points`,`status`) VALUES ('$donateDate','$donateRef','$donateAccount','$donateMethod','$donatePrice','$donatePoints','waiting')");
					elseif($donateMethod == "paypal")
						$add_order = $SQL->query("INSERT INTO `z_shop_donates` (`date`,`reference`,`account_name`,`method`,`price`,`points`,`status`) VALUES ('$donateDate','$donateRef','$donateAccount','$donateMethod','$donatePrice','$donatePoints','confirm')");
					else
						$add_order = $SQL->query("INSERT INTO `z_shop_donates` (`date`,`reference`,`account_name`,`method`,`price`,`points`,`status`) VALUES ('$donateDate','$transRef','$donateAccount','$donateMethod','$donatePrice','$donatePoints','confirm')");
				}
			}
