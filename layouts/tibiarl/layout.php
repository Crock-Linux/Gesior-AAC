...
<div id='support_Submenu' class='Submenu'>
			...
			<div class="ThemeboxButton">
				...
				<input class="ButtonText" type="image" name="Get Premium" alt="Get Premium" src="<?php echo $layout_name; ?>/images/global/buttons/_sbutton_getextraservice.gif">
				</div>
				</div>
				</form>
				</div>
			...
			<!-- Server Info theme box -->
				<div id="ScreenshotBox" class="Themebox" style="background-image:url(<?php echo $layout_name; ?>/images/global/themeboxes/serverinfo/serverinfobox.gif);">
					<a href="?subtopic=serverinfo">
